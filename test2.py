...
response = model.generate_content(full+" generate one questions to ask a search engine about the above information - return a string")
final=response.text.split(" !@# ")
async def main():
    browser = await launch()
    page = await browser.newPage()
    await page.goto(f'https://www.google.com/search?q={i}')